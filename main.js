        ...
        tbody.append(`
                    <tr style="background-color: rgba(242,242,242,0.5)">
                        ...
                        <td>
                            ...
                            <img src="https://cdn-icons.flaticon.com/png/512/644/premium/644276.png?token=exp=1640340798~hmac=9a0118bda8acdece5531d87a6736c96e">
                        </button>
                        </td>
...
function addPagination(pagesCount) {
    ...
    for(let i = 1; i <= pagesCount; i++) {
        ...
        <a class="page-link pagination-item" href="#">${i}
        </a></li>
        `)
    }
